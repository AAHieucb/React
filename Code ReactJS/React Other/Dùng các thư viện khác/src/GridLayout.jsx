...
const ShowcaseLayout = (props) => {
  ...
  const generateDOM = () => {
    return _.map(state.layouts.lg, function(l, i) { // map của lodash như map bth là duyệt qua state.layouts.lg
      return (
  ...
  return (
    <div>
      ...
      {/* react-grid-layout chỉ cần chú ý component ResponsiveReactGridLayout và các options */}
      <ResponsiveReactGridLayout
        ...
        // Animate on mount. If dont want, delete `useCSSTransforms` (default `true`) and set `measureBeforeMount={true}`.
