...
// export như này thì hàm function* handleFetchData bên trên mới dùng được vì nó coi như là đặt thành các biến có tên như v ở trong file để dùng fetchDataSuccess, fetchDataFail
