...
function App() {
  ...
  return (
    <>
      ...
      {/* Mọi kiểu vẽ luôn phải có svg bao ngoài. 2 thuộc tính animtion:
        ...
        => Để có animation, cho đường dash length và gap dài bằng path gốc, r dung stroke-dashoffset để dịch path đến vị trí hide hoàn toàn đường dash, chỉ hiện mỗi gap ban đầu và animation nó tăng dần.
      ...
      */}
      ...
      {/* Framermotion tự gán sẵn stroke-dasyarray và stroke-dashoffset. Ta chỉ cần animate cái pathLength phát là xong. Mọi thứ về path và svg khác giữ nguyên */}
      ...
      {/* Thêm animation khi exit và xh, VD khi remove khỏi 1 list. Giá trị animation là 1 biến và biến đó thay đổi giá trị thì cũng có animation chuyển đổi */}
      <AnimatePresence>
        {show && (
          <motion.div
            key= "a box"
      ...
      {/* AnimationPresence và motion mặc định tạo animation khi lần đầu mount và unmount. Dùng initial và whileInView sẽ custom được mỗi khi vào viewport dựa vào scroll */}
