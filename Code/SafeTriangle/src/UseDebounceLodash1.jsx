...
const UseDebounceLodash1 = () => {
  ...
  // Mặc định debounce chỉ thực hiện hàm khi event kết thúc sau khoảng delay time.
  // Thêm leading thì nó sẽ thực hiện hàm ngay 1 lần khi trigger sự kiện lần đầu tiên. Còn trailing thì nó sẽ thực hiện khi chuỗi event ngừng sau delay time. Tức nếu trailing là false thì debounce chả làm gì cả. Mặc định debounce thì leading false, trailing true. Mặc định throttle thì leading true, trailing true
